 ...
 *
 * <p>
 * Description: Fuzzy Data Base</p>
 *
 * <p>
 * Copyright: Copyright KEEL (c) 2008</p>
 *
 * <p>
 * Company: KEEL </p>
 *
...
public class DataBase {
    ...
    public DataBase(int nLabels, myDataset train) {
        ...
        for (int i = 0; i < this.n_variables; i++) {
            ...
            } else if (train.isInteger(i) && ((rank + 1) <= nLabels)) {
                this.nLabels[i] = ((int) rank) + 1;
            } else {
