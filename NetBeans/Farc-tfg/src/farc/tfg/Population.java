 ...
 *
 * <p>
 * Description: This class contains the population for the CHC algorithm</p>
 *
 * <p>
 * Copyright: KEEL Copyright (c) 2010</p>
 *
 * <p>
 * Company: KEEL </p>
 *
...
public class Population {
    ...
    int n_variables, pop_size, maxTrials, nTrials, BITS_GEN, numReiniciosSinMejora;
    double best_fitness, best_accuracy, bestFitness;
    int[] selected;
    String evolution;
    ...
    public Population(myDataset train, DataBase dataBase, RuleBase ruleBase, int size, int BITS_GEN, int maxTrials, double alpha) {
        ...
        this.Lini = ((dataBase.getnLabelsReal() * ruleBase.size() * BITS_GEN) + ruleBase.size()) / 2.0;
        this.L = this.Lini;
//		this.ruleBase.evaluate();
    ...
    public void Generation() {
        ...
        int tipoCruce = 0;//emepzamos con el two point (1) y luego pasamos al pcblx (0)
        do {
            this.selection();
            this.crossover();
        ...
        } while ((this.nTrials < this.maxTrials) && (this.numReiniciosSinMejora < 3));
    }
    ...
    private void twoPoint(Individual son1, Individual son2) {
        son1.twoPoint(son2);
    }
